        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          <div className="flex items-center gap-6">
            ...
            <div className="hidden items-center gap-1 sm:flex">
              <Link href="/dashboard">
                <Button variant="ghost" size="sm" className="text-stone-300 hover:text-white hover:bg-stone-800">Dashboard</Button>
              </Link>
              <Link href="/inquiries">
                <Button variant="ghost" size="sm" className="text-stone-300 hover:text-white hover:bg-stone-800">Inquiries</Button>
              </Link>
              <Link href="/clients">
                <Button variant="ghost" size="sm" className="text-stone-300 hover:text-white hover:bg-stone-800">Clients</Button>
              </Link>
            </div>
          </div>
          <Button variant="ghost" size="sm" className="bg-gold-500/20 text-gold-300 hover:bg-gold-500/30 hover:text-gold-200">
